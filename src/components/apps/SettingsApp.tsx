...
export default function SettingsApp() {
  ...
  const activeNetwork =
    gamePhase >= 2 ? QUEST_CONFIG.wifi.targetSSID : localConnected;
        ...
        <div className={styles.content}>
            ...
            <>
                ...
                >
                  ...
                  <div className={styles.itemRight}>
                    <span className={styles.valueText}>
                      {activeNetwork ? activeNetwork : "Not Connected"}
                    </span>
              ...
              <div className={styles.list} style={{ marginTop: 24 }}>
                <div className={styles.listItem} onClick={toggleSound}>
                  ...
                  <div className={styles.itemRight}>
                    <div
                      className={`${styles.toggle} ${SensoryEngine.soundEnabled ? styles.toggleOn : ""}`}
                    ></div>
                  </div>
                </div>
                <div className={styles.listItem} onClick={toggleHaptics}>
                  ...
                  <div className={styles.itemRight}>
                    <div
                      className={`${styles.toggle} ${SensoryEngine.hapticsEnabled ? styles.toggleOn : ""}`}
                    ></div>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.list} style={{ marginTop: 24 }}>
                <div
                  className={styles.listItem}
                  onClick={() =>
                    setNavStyle(navStyle === "gesture" ? "buttons" : "gesture")
                  }
                >
                  <div
                    className={styles.iconBox}
            ...
            <div className={styles.list}>
              ...
              <div
                ...
                onClick={() =>
                  ...
                  setPromptNetwork(QUEST_CONFIG.wifi.targetSSID)
                }
              >
              ...
              <div
                className={styles.listItem}
                onClick={() =>
                  activeNetwork !== "Guest_Net" && setPromptNetwork("Guest_Net")
                }
              >
          ...
          {view === "about" && (
            <div className={styles.list}>
              ...
              <div
                className={styles.listItem}
                onClick={() => setEasterEggCount((c) => c + 1)}
              >
                <div className={styles.itemText}>Developer</div>
                <div className={styles.itemRight}>
                  <span className={styles.valueText}>
                    {QUEST_CONFIG.about.developer}
                  </span>
                </div>
              </div>
              <div className={styles.listItem}>
                <div className={styles.itemText}>OS</div>
                <div className={styles.itemRight}>
                  <span className={styles.valueText} style={{ fontSize: 12 }}>
                    {QUEST_CONFIG.about.osName}
                  </span>
                </div>
              </div>
              <div className={styles.listItem}>
              ...
              >
                <div className={styles.itemText}>Kernel</div>
                <div
                  style={{
                    fontSize: "10px",
                    color: "#8e8e93",
          ...
          <div className={styles.promptOverlay}>
            <div className={styles.promptBox}>
              ...
              <div className={styles.promptActions}>
                ...
                <button style={{ fontWeight: 600 }} onClick={handleConnect}>
                  Join
                </button>
              </div>
            </div>
